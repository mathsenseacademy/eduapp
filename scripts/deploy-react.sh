#!/usr/bin/env bash
# ---------------------------------------------------------------------------
#  Deploy React build to Nginx on EC2
# ---------------------------------------------------------------------------
set -e  # stop on first error

APP_DIR="/home/ubuntu/eduapp"      # where CodeDeploy put the bundle
BUILD_DIR="$APP_DIR/build"         # CRA / Vite build output
