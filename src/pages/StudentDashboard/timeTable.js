// src/pages/StudentDashboard/timeTable.js
...
// Consolidate all days into one object for easy lookup:
const timeTable = { Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday };
